...
- 8 posts: immigration psychological evaluations
- 5 posts: pre-surgical and bariatric psychological evaluations
- 4 posts: women's mental health, prenatal, postpartum, body image
- 2 posts: divorce and self-compassion
- 1 post: multilingual/local trust
...
Image: src/assets/Immigration evaluations.png

### 02 - What to Expect

Text: An immigration psychological evaluation usually includes a clinical interview, review of relevant history, standardized measures when appropriate, and a written report. The goal is careful clinical documentation, not legal advice. Appointments are available in Schaumburg and by Illinois telehealth when appropriate.
...
Image: src/assets/Jelena-Djurovic-headshot.jpg
...
### 06 - Illinois Telehealth

Text: Immigration psychological evaluations are available in person in Schaumburg, and telehealth may be available for clients located elsewhere in Illinois when clinically appropriate. The evaluation process focuses on clear clinical history, functioning, symptoms, and documentation.
...
Image: src/assets/Psychological Assessment.png
...
### 12 - Bariatric Readiness

Text: Bariatric surgery can bring physical, emotional, and lifestyle changes. A psychological evaluation can help clarify readiness, strengths, support systems, and areas where additional preparation may be helpful before surgery.
